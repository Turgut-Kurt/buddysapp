...
class Chat extends React.Component {
  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      await this.setState({ otherUser: otherUser.data, user: user.data, loading: false, })
  ...
  renderBubble = props => {
    ...
    return (
      ...
      this.state.otherUser ? <View style={styles.messageWrapper}>
        <View
          style={[
            styles.messageBox,
    ...
    return (
      <View style={styles.backgroundView}>
        <View style={styles.topView}>
          ...
          <Text style={styles.titleText}>{otherUser ? otherUser.first_name : null}</Text>
          <View style={{ flex: 1, alignItems: 'flex-end' }}>
            <TouchableOpacity onPress={() => {
              ...
              <Image
                source={
                  otherUser
                    ? { uri: Config.baseURL + otherUser.profile.photo.replace(Config.baseURL, '') }
                    : NoUserImage
                }
